...
#define TR_RW_Coefficient 3263.8f  //This is the right wheel coefficient of the power function for Turn Radius vs Steering Angle
#define TR_RW_Power -1.272f    //This is the right wheel power of the power function for Turn Radius vs Steering Angle
